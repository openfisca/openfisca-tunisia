...
CES DEUX GARDES SONT NÉES D'ACCIDENTS RÉELS.
  ...
  2. La PR #430 a retiré deux de ces mentions. La PR #432, coupée d'une branche antérieure,
     les a silencieusement RÉINTRODUITES en fusionnant. Rien ne l'a signalé.
"""
...
PARAMETRES = pathlib.Path(__file__).parent.parent / "openfisca_tunisia" / "parameters"
