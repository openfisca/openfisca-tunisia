...
* Zones impactées : `parameters/retraite/rtns`, `parameters/retraite/rtfr`, `parameters/retraite/raci`, `units.yaml`.
* Détails :
  - **Verse les paramètres de pension de trois régimes du secteur privé dont l'arbre ne portait que les cotisations** : les travailleurs non salariés (décret n° 95-1166), les travailleurs à faibles revenus (loi n° 2002-32) et les artistes, créateurs et intellectuels (loi n° 2002-104, décret n° 2003-894). Tous les textes sont lus sur pièce ; plusieurs fascicules ont une couche texte décalée, décodée.
