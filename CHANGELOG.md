...
* Détails :
  ...
  - Tests : `tests/formulas/test_indemnites_familiales_droits_acquis.yaml` porte **seize cas** en YAML — l'entrée en vigueur au mois près (décembre 1985 et avril 1986 à zéro, mai 1986 à 24,400), la bascule de 1989 au mois près (décembre 1988 contre janvier 1989, sur le même foyer de quatre enfants : 24,400 puis 19,700), les deux situations qui y échappent (droit acquis, enfant handicapé), le régime antérieur en 1987, le régime actuel en 1990 et 2024, le cas courant de trois enfants, et la borne qui empêche de déclarer plus d'enfants qu'il n'y en a. Les quatre tests existants de `test_accessoires.yaml` passent **sans modification** : ils portent sur un et trois enfants, que la limitation ne touche pas. `make test` : 132 tests passent, contre 116 sur `master`.
