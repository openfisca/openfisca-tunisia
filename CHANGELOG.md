...
* Détails :
  ...
  - Les calculs restent impossibles avant le 5 mars 1985 : les paramètres `cadre_commun` et `meres_3_enfants` du départ anticipé ne commencent qu'à cette date.
  - Tests : `tests/formulas/test_astreignants.py` vérifie le taux de liquidation au 1er juin, au 11, au 12 et au 24 septembre 1985, et l'âge requis des astreignants en 1985, 2019 et 2020. Aucun test existant ne change.
  - Rapport d'audit régénéré : le décret n° 85-1178 n'est plus cité comme source de valeurs ; la loi n° 85-12 l'est par 25 paramètres, la loi n° 2019-37 par 5.
