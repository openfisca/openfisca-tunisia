...
from openfisca_tunisia.variables.prelevements_obligatoires.impot_revenu.irpp import (
    calcule_base_imposable,
)
...
class contribution_sociale_solidarite_nette_a_payer(Variable):
    ...
    def formula(foyer_fiscal, period, parameters):
        return foyer_fiscal(
            "contribution_sociale_solidarite", period
        ) - foyer_fiscal.sum(
...
class contribution_sociale_solidarite_prelevee_a_la_source(Variable):
    ...
    def formula_2020_01_01(individu, period, parameters):
        ...
        irpp_salarie_preleve_a_la_source = individu(
            "irpp_salarie_preleve_a_la_source", period=period
        )
        non_exonere_irpp, revenu_assimile_salaire_apres_abattement = (
            calcule_base_imposable(
        ...
        return non_exonere_css * (
            ...
            * bareme_irpp.calc(
                (
                    12 * revenu_assimile_salaire_apres_abattement
