...
#    ('rbg', Prestation(ir._rbg, entity = 'foy', label = u"Revenu brut global")),
    ...
    ('deduc_fam', Prestation(ir._deduc_fam, entity = 'foy',
        label = u"Déductions pour situation et charges de famille")),
    ('deduc_rente', Prestation(ir._deduc_rente, entity = 'foy',
    ...
    ('smig', Prestation(ir._smig, entity = 'foy',
        label = u"Indicatrice de SMIG ou SMAG déduite du montant des salaires")),

    ('deduc_smig', Prestation(ir._deduc_smig, entity = 'foy',
